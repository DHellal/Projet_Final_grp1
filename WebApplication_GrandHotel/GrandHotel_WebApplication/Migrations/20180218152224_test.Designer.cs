...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Adresse", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Calendrier", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Chambre", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Facture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.LigneFacture", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.ModePaiement", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Reservation", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Tarif", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.TarifChambre", b =>
                {
                    b.Property<short>("NumChambre");
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Telephone", b =>
                {
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Adresse", b =>
                {
                    b.HasOne("GrandHotel_WebApplication.Models.Client", "IdClientNavigation")
                        .WithOne("Adresse")
                        .HasForeignKey("GrandHotel_WebApplication.Models.Adresse", "IdClient")
                        .HasConstraintName("FK_Adresse_Client");
                });

            modelBuilder.Entity("GrandHotel_WebApplication.Models.Facture", b =>
                {
                    b.HasOne("GrandHotel_WebApplication.Models.ModePaiement", "CodeModePaiementNavigation")
                        .WithMany("Facture")
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.LigneFacture", b =>
                {
                    b.HasOne("GrandHotel_WebApplication.Models.Facture", "IdFactureNavigation")
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("GrandHotel_WebApplication.Models.Calendrier", "JourNavigation")
                        .WithMany("Reservation")
                        .HasForeignKey("Jour")
                        .HasConstraintName("FK_Reservation_Calendrier");

                    b.HasOne("GrandHotel_WebApplication.Models.Chambre", "NumChambreNavigation")
                        .WithMany("Reservation")
            ...
            modelBuilder.Entity("GrandHotel_WebApplication.Models.TarifChambre", b =>
                {
                    b.HasOne("GrandHotel_WebApplication.Models.Tarif", "CodeTarifNavigation")
